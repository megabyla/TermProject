    ...
    <form id="form1" runat="server">
        <div class="m-4">
            ...
            <br />
             ...
             <div runat="server" id="deleteDiv" visible=" false"><br /><br />
                    ...
                    <div runat="server" id="displayDiv" visible="true" style="padding-left: 15px; padding-right: 15px; ">
                        <h3>All Furniture: </h3><asp:Label ID="lblMessageDisplay" runat="server" Text="Label"></asp:Label>
                        &nbsp;<asp:GridView ID="gvAllFurniture" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="gvAllFurniture_SelectedIndexChanged" Height="550px" Width="1890px" >
